...
export default function MainFooter() {
  return (
    <Row style={{ backgroundColor: "black", color: 'white' }}>
      <Col id="logofooter" xs={{ span: 12 }} sm={{ span: 8 }} md={{ span: 8 }} lg={{ span: 8 }} xl={{ span: 8 }} style={{ textAlign: 'center' }}>
        <img src={logoFooter1} alt="" style={{ width: '50px', height: '50px' }} />
        {/* <img src={logoFooter2} alt="" style={{width:'50px', height:'50px'}}/> */}
      </Col>
      <Col xs={{ span: 12 }} sm={{ span: 8 }} md={{ span: 8 }} lg={{ span: 8 }} xl={{ span: 8 }} style={{ textAlign: 'center' }}>
        <Title id="copyright" level={5} style={{ color: "white", padding: '10px 0px', fontSize: '15px' }}>
          GLOD Sportwear ©2022 Created by GLOD
        </Title>
      </Col>
      <Col id="social" xs={{ span: 24 }} sm={{ span: 8 }} md={{ span: 8 }} lg={{ span: 8 }} xl={{ span: 8 }} style={{ textAlign: 'center' }} >
